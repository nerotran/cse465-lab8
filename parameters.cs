...
namespace Params {
    class Program {
        ...
        public static bool TryParseInt(ref int value) {
            try {
        ...
        public static void Main() {
            ...
            while (!TryParseInt(ref a)) //<-- You will need to change something here
            { 
                Console.WriteLine();
            ...
            while (!TryParseInt(ref b)) { //<-- You will need to change somehing here
                Console.WriteLine();
                Console.WriteLine("ERROR - Invalid number.");
